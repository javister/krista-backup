...
Некоторые действия поддерживают запуск в тестовом режиме. При выполнении
действия в данном режиме будет формироваться лог выполняемых действий, но
не будут выполняться изменения.
...
2. Указать действие в задании в виде [action_name, --dry]
  ...
  Пример можно найти :ref:`здесь <configuration_task_example>`.
