...
Подробнее смотрите :ref:`раздел "Использование" <usage>` или docs/text/usage.txt
...
Подробнее о конфигурировании можно прочитать в :ref:`разделе "Конфигурация" <configuration>`
