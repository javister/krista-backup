...
class Rsync(Action):
    ...
    def excecute_cmdline(self, cmdline, log=True):
    ...
    def get_filelist(self):
        ...
        listing = self.excecute_cmdline(cmdline, log=False).split('\n')
        ...
        # парсинг имён
        file_listing = list(
            map(lambda string: string[name_start_index:], file_listing),
        )
        dir_listing = list(
            map(lambda string: string[name_start_index:], dir_listing),
        )
